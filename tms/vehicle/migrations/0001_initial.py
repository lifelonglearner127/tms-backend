    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_registered_on', models.DateField(blank=True, null=True)),
                ('license_active_on', models.DateField(blank=True, null=True)),
                ('license_expires_on', models.DateField(blank=True, null=True)),
                ('operation_permit_active_on', models.DateField(blank=True, null=True)),
                ('operation_permit_expires_on', models.DateField(blank=True, null=True)),
                ('insurance_active_on', models.DateField(blank=True, null=True)),
                ('insurance_expires_on', models.DateField(blank=True, null=True)),
                ('license_type_2', models.CharField(blank=True, max_length=100, null=True)),
                ('license_id_2', models.CharField(blank=True, max_length=100, null=True)),
                ('license_authority_2', models.CharField(blank=True, max_length=100, null=True)),
                ('license_registered_on_2', models.DateField(blank=True, null=True)),
                ('license_active_on_2', models.DateField(blank=True, null=True)),
                ('license_expires_on_2', models.DateField(blank=True, null=True)),
                ('operation_permit_active_on_2', models.DateField(blank=True, null=True)),
                ('operation_permit_expires_on_2', models.DateField(blank=True, null=True)),
                ('insurance_active_on_2', models.DateField(blank=True, null=True)),
                ('insurance_expires_on_2', models.DateField(blank=True, null=True)),
                ('branches', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(), size=None)),
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('status', models.PositiveIntegerField(choices=[(0, 'Available'), (1, 'Driver on'), (2, 'Escort on'), (3, 'Under wheel'), (4, 'Repair')], default=0)),
            ],
            options={
                'ordering': ['-updated'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deduction_score', models.PositiveIntegerField(default=0)),
                ('status', models.CharField(blank=True, max_length=100, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('violates_on', models.CharField(blank=True, max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
