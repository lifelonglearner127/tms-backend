    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.PositiveIntegerField(choices=[(3, 'Bill from Oil Station'), (0, 'Bill from Loading Station'), (2, 'Bill from UnLoading Station'), (1, 'Bill from Quality Station'), (4, 'Bill from traffic')], default=0)),
