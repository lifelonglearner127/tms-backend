...
USER_TYPE = (
    ...
    (USER_TYPE_ESCORT, '外驾驶人员'),
    (USER_TYPE_ESCORT, '外押运人员'),
...
ORDER_PAYMENT_STATUS_PENDING = 1
ORDER_PAYMENT_STATUS_TICKET = 2
ORDER_PAYMENT_STATUS_COMPLETE = 3
ORDER_PAYMENT_STATUS = (
    (ORDER_PAYMENT_STATUS_NO_DISTANCE, '待更新'),
    (ORDER_PAYMENT_STATUS_PENDING, '待对账'),
    (ORDER_PAYMENT_STATUS_TICKET, '待开票'),
...
EVENT_TYPE_VEHICLE_CERTIFICATE_EXPIRED = 1
EVENT_TYPE_VEHICLE_INSURANCE_EXPIRED = 2
EVENT_TYPE_VEHICLE_LICENSE_EXPIRED = 3
EVENT_TYPE = (
    (EVENT_TYPE_DRIVER_LICENSE_EXPIRED, '驾驶证'),
    (EVENT_TYPE_VEHICLE_CERTIFICATE_EXPIRED, '车辆运营证'),
...
NOTIFICATION_TYPE = (
    (DRIVER_NOTIFICATION_NEW_JOB,
        'New Job Notification'),
    (DRIVER_NOTIFICATION_UPDATE_JOB,
        'Update Job Notification'),
    (DRIVER_NOTIFICATION_DELETE_JOB,
        'Delete Job Notification'),
    (DRIVER_NOTIFICATION_TYPE_ENTER_STATION,
        'Enter Area Notification'),
    (DRIVER_NOTIFICATION_TYPE_EXIT_STATION,
        'Exit Area Notification'),
    (DRIVER_NOTIFICATION_TYPE_ENTER_BLACK_DOT,
        'Enter Black Dot Notification'),
    (DRIVER_NOTIFICATION_TYPE_EXIT_BLACK_DOT,
        'Exit Black Dot Notification'),
