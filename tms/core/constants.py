...
STAFF_NOTIFICATION_REST_REQUEST_APPROVED = 11
STAFF_NOTIFICATION_REST_REQUEST_DECLINE = 12
STAFF_NOTIFICATION_VEHICLE_REPAIR_REQUEST = 20
STAFF_NOTIFICATION_VEHICLE_REPAIR_REQUEST_RESULT = 21
STAFF_NOTIFICATION_PARKING_REQUEST = 30
STAFF_NOTIFICATION_PARKING_REQUEST_RESULT = 31
STAFF_NOTIFICATION_DRIVER_CHANGE_REQUEST = 40
STAFF_NOTIFICATION_DRIVER_CHANGE_REQUEST_RESULT = 41
STAFF_NOTIFICATION_ESCORT_CHANGE_REQUEST = 50
STAFF_NOTIFICATION_ESCORT_CHANGE_REQUEST_RESULT = 51
STAFF_NOTIFICATION_TRAFFIC_ACCIDENT = 60
...
NOTIFICATION_TYPE = (
    ...
    (STAFF_NOTIFICATION_REST_REQUEST_APPROVED,
        'Rest Request Notification Approved'),
    (STAFF_NOTIFICATION_REST_REQUEST_DECLINE,
        'Rest Request Notification Decline'),
    (STAFF_NOTIFICATION_VEHICLE_REPAIR_REQUEST,
        'Vehicle Maintenance Notification'),
    (STAFF_NOTIFICATION_VEHICLE_REPAIR_REQUEST_RESULT,
        'Vehicle Maintenance Notification Result'),
    (STAFF_NOTIFICATION_PARKING_REQUEST, 'Parking Request Notification'),
    (STAFF_NOTIFICATION_PARKING_REQUEST_RESULT,
        'Parking Request Notification Result'),
    (STAFF_NOTIFICATION_DRIVER_CHANGE_REQUEST, 'Driver Change Notification'),
    (STAFF_NOTIFICATION_DRIVER_CHANGE_REQUEST_RESULT,
        'Driver Change Notification Result'),
    (STAFF_NOTIFICATION_ESCORT_CHANGE_REQUEST, 'Escort Change Notification'),
    (STAFF_NOTIFICATION_ESCORT_CHANGE_REQUEST_RESULT,
        'Escort Change Notification Result'),
