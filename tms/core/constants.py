...
STATION_TYPE_GET_OFF_STATION = 'G'
STATION_TYPE_BLACK_DOT = 'B'
STATION_TYPE_PARKING_STATION = 'P'
STATION_TYPE_REPAIR_STATION = 'R'
STATION_TYPE_CUSTOM_POINT = 'C'
STATION_TYPE = (
...
DRIVER_NOTIFICATION_TYPE_ENTER_STATION = 3
DRIVER_NOTIFICATION_TYPE_EXIT_STATION = 4
DRIVER_NOTIFICATION_TYPE_ENTER_BLACK_DOT = 5
DRIVER_NOTIFICATION_TYPE_EXIT_BLACK_DOT = 6
# reserved 7-9
