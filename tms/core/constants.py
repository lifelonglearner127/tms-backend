...
VEHICLE_MAINTENANCE_CATEGORY_0 = 0
VEHICLE_MAINTENANCE_CATEGORY_1 = 1
VEHICLE_MAINTENANCE_CATEGORY_2 = 2
VEHICLE_MAINTENANCE_CATEGORY_3 = 3
VEHICLE_MAINTENANCE_CATEGORY_4 = 4
VEHICLE_MAINTENANCE_CATEGORY_5 = 5
VEHICLE_MAINTENANCE_CATEGORY_6 = 6
VEHICLE_MAINTENANCE_CATEGORY_7 = 7
VEHICLE_MAINTENANCE_CATEGORY_8 = 8
VEHICLE_MAINTENANCE_CATEGORY_9 = 9
VEHICLE_MAINTENANCE_CATEGORY_0 = 0
VEHICLE_MAINTENANCE_CATEGORY_10 = 10
VEHICLE_MAINTENANCE_CATEGORY_11 = 11
VEHICLE_MAINTENANCE_CATEGORY_12 = 12
VEHICLE_MAINTENANCE_CATEGORY_13 = 13
VEHICLE_MAINTENANCE_CATEGORY_14 = 14
VEHICLE_MAINTENANCE_CATEGORY_15 = 15
VEHICLE_MAINTENANCE_CATEGORY_16 = 16
VEHICLE_MAINTENANCE_CATEGORY_17 = 17
VEHICLE_MAINTENANCE_CATEGORY_18 = 18
VEHICLE_MAINTENANCE_CATEGORY_19 = 19
VEHICLE_MAINTENANCE_CATEGORY = (
    (VEHICLE_MAINTENANCE_CATEGORY_0, '车辆保养'),
    (VEHICLE_MAINTENANCE_CATEGORY_1, '换季保养'),
    (VEHICLE_MAINTENANCE_CATEGORY_2, '主车保轮'),
    (VEHICLE_MAINTENANCE_CATEGORY_3, '挂车保轮'),
    (VEHICLE_MAINTENANCE_CATEGORY_4, '车辆电器路维修'),
    (VEHICLE_MAINTENANCE_CATEGORY_5, '轮胎维修'),
    (VEHICLE_MAINTENANCE_CATEGORY_6, '轮胎更换'),
    (VEHICLE_MAINTENANCE_CATEGORY_7, '附属设备维修'),
    (VEHICLE_MAINTENANCE_CATEGORY_8, '中集设备维修'),
    (VEHICLE_MAINTENANCE_CATEGORY_9, '车辆救援费用'),
    (VEHICLE_MAINTENANCE_CATEGORY_0, '车辆物品配备车辆保养'),
    (VEHICLE_MAINTENANCE_CATEGORY_10, '换季保养'),
    (VEHICLE_MAINTENANCE_CATEGORY_11, '主车保轮'),
    (VEHICLE_MAINTENANCE_CATEGORY_12, '挂车保轮'),
    (VEHICLE_MAINTENANCE_CATEGORY_13, '车辆电器路维修'),
    (VEHICLE_MAINTENANCE_CATEGORY_14, '轮胎维修'),
    (VEHICLE_MAINTENANCE_CATEGORY_15, '轮胎更换'),
    (VEHICLE_MAINTENANCE_CATEGORY_16, '附属设备维修'),
    (VEHICLE_MAINTENANCE_CATEGORY_17, '中集设备维修'),
    (VEHICLE_MAINTENANCE_CATEGORY_18, '车辆救援费用'),
    (VEHICLE_MAINTENANCE_CATEGORY_19, '车辆物品配备'),
)
...
EVENT_TYPE_DRIVER_WORK_LICENSE_EXPIRED = 4
EVENT_TYPE = (
    ...
    (EVENT_TYPE_DRIVER_WORK_LICENSE_EXPIRED, '从业资格证'),
)
...
DRIVER_NOTIFICATION_FINISH_JOB = 2
...
CUSTOMER_NOTIFICATION_DELETE_ARRANGEMENT = 75
...
NOTIFICATION_TYPE = (
    ...
    (DRIVER_NOTIFICATION_FINISH_JOB, 'Finish Job'),
    ...
    (CUSTOMER_NOTIFICATION_DELETE_ARRANGEMENT, 'Delete Arrangement'),
...
VEHICLE_DEPARTMENT_TYPE_OIL = 0
VEHICLE_DEPARTMENT_TYPE_SHELL = 1
VEHICLE_DEPARTMENT_TYPE_OUTSIDE = 2
VEHICLE_DEPARTMENT_TYPE = (
    (VEHICLE_DEPARTMENT_TYPE_OIL, '油品部门'),
    (VEHICLE_DEPARTMENT_TYPE_SHELL, '壳牌'),
    (VEHICLE_DEPARTMENT_TYPE_OUTSIDE, '外协车辆'),
)
