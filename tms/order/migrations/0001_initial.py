    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.PositiveIntegerField(choices=[(3, '加油'), (4, '路票'), (5, '其他')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product_delivers', to='order.Job')),
        ...
        migrations.AddField(
            model_name='job',
            name='bills',
            field=models.ManyToManyField(to='order.JobBill'),
        ),
        migrations.AddField(
            model_name='job',
            name='driver',
