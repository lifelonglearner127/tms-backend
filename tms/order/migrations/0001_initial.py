    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mission_weight', models.FloatField(blank=True, null=True)),
                ('loading_weight', models.FloatField(blank=True, null=True)),
                ('unloading_weight', models.FloatField(blank=True, null=True)),
