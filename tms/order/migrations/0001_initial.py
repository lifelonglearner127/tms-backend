# Generated by Django 2.2.1 on 2019-05-17 17:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobs', models.ManyToManyField(through='order.Job', to='vehicle.Vehicle')),
                ('order_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='order.OrderProduct')),
                ('unloading_station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.UnLoadingStation')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='job',
            name='mission',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='order.OrderProductDeliver'),
        ),
        migrations.AddField(
            model_name='job',
            name='vehicle',
