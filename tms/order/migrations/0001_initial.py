    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loading_station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.LoadingStation')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='order.OrderLoadingStation', to='info.LoadingStation'),
        ),
    ]
